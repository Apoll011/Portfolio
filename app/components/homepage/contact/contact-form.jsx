...
function ContactForm() {
  ...
  return (
    <div>
      <p className="font-medium mb-5 text-[#16f2b3] text-xl uppercase">Entre em Contacto</p>
      <div className="max-w-3xl text-white rounded-lg border border-[#464c6a] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            />
            {error.email && <p className="text-sm text-red-400">Por favor digite um email valido!</p>}
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            {error.required && <p className="text-sm text-red-400">
              Todos os Campos são Obrigatórios! Por favor preencha todos os campos para enviar a sua mensagem
            </p>}
            <button
