...
function page() {
  return (
    <div className="flex flex-col items-center justify-center h-screen text-center">
      ...
      <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">Pagina não Encontrada</p>
      <p className="mt-2 text-gray-500 dark:text-gray-400">Desculpe, mas a página que procurás, não existe.</p>
